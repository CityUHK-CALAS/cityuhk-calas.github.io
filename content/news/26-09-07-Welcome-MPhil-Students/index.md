...
<div style="display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 14px; align-items: stretch;">
  <img src="featured.jpg" alt="Charlie, Yann, and Frisk with Prof. Ray" style="width: 100%; aspect-ratio: 3 / 4; object-fit: cover;">
  <img src="image1.jpg" alt="Justin and Prof. Ray" style="width: 100%; aspect-ratio: 3 / 4; object-fit: cover;">
</div>
